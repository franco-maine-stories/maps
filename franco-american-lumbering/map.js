...
if (config.toptitle) {
    var toptitleText = document.createElement('h4');
    toptitleText.innerHTML = config.toptitle;
    header.appendChild(toptitleText);
}
if (config.title) {
...
config.chapters.forEach((record, idx) => {
    ...
    // Creates the sub-title for the vignettes
    if (record.subtitle) {
        var subtitle = document.createElement('h3');
        title.innerText = record.subtitle;
